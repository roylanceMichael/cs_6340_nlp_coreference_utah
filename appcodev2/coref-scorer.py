...
#
# Usage:   ./coref-scorer.py <listfile> <official-keys-directory> [-V (optional)]
# Example: ./coref-scorer.py /home/riloff/listfile.txt /home/riloff/keys/
#
# The optional -V flag will produce more verbose scoring information. 
#
import sys
import re
import copy
